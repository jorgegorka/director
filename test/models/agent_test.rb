...
class AgentTest < ActiveSupport::TestCase
  ...
  test "adapter returns correct adapter class for claude_local" do
    assert_equal Adapters::ClaudeLocalAdapter, @claude_agent.adapter
  end

  test "adapter returns correct adapter class for http" do
    assert_equal Adapters::HttpAdapter, @http_agent.adapter
  end

  test "adapter returns correct adapter class for process" do
    assert_equal Adapters::ProcessAdapter, @process_agent.adapter
  end
