class HeartbeatEvent < ApplicationRecord
  ...
  enum :trigger_type, { scheduled: 0, task_assigned: 1, mention: 2, hook_triggered: 3, review_validation: 4, task_evaluation_failed: 5, question_asked: 6, question_answered: 7, manual: 8, root_task_assigned: 9, task_pending_review: 10 }
